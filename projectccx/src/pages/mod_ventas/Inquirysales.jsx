    ...
    return(
        ...
        <div className="sidebar">
            ...
            <div className="sidebar-menu">
                <ul>
                    <li>
                        <a href="../index.html" className="product"><span className="product"></span>
                        <img src={images.img_createw} width="30px" height="30px" alt=""/><span>Inicio</span></a>
                    </li>
                    <li>
                        <a href="Consulta de ventas" className="active"><span className="home"></span>
                        <img src={images.img_searchb} width="30px" height="30px" alt=""/>Consulta de ventas</a>
                    </li>
                    <li>
                        <a href="reg_vta.html" className="product"><span className="product"></span>
